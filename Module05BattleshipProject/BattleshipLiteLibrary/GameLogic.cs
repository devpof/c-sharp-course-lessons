...
// this is intentionally not in the Models Library because
...
namespace BattleshipLiteLibrary
{
    public static class GameLogic
    {
        ...
        {
            // simpler way to initialize a List without
            // doing the List.Add method
        ...
        public static (string row, int column) SplitShotIntoRowAndColumn(string shot)
        {
            ...
            column = int.Parse(shotArray[1].ToString()); //shotArray[1] works because it is using the ASCII number instead.

            //it maps to the tuple in your method signature not the local variables row and column
            return (row, column);
        }
